...
const LANG_DICT = {
    ...
    "ja": {
		...
		menu_system_title: "システムメニュー", menu_gacha: "ガチャシミュレーターへ", menu_viewer: "アニメーション展示へ", menu_tier_maker: "ティアメーカーへ", menu_checklist: "マイカスタムリスト", menu_toggle_anim: "ランニングアニメーション切替",

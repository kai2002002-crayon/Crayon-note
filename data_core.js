...
const LANG_DICT = {
    ...
    "ja": {
		...
		"羅蕾特": "ロレット", "琵拉": "琵拉", "雪蘭": "シェルム", "芭莉耶": "バリエ",
    ...
    "en": {
        ...
        "羅蕾特": "Rollett", "琵拉": "Pira", "雪蘭": "Sherum", "芭莉耶": "Barie",
...
// ------------------------------------------
const INITIAL_DATA = [
	{ name: "芭莉耶", personality: "憂鬱", race: "魔女", position: "後排", job: "輔助", pathVersion: "", releaseDate: "2026-09-10T17:00:00+09:00" },
...
const CV_MAP = {
	...
	"羅蕾特": "日野麻里", "琵拉": "菱川花菜", "雪蘭": "安齋由香里", "芭莉耶": "寺澤百花"
",
};
...
const COSTUME_MAP = {
	...
	"羅蕾特": ["Rollett", "RollettSkin2"], "琵拉": ["Pira", "PiraSkin1", "PiraSkin2"], "雪蘭": ["Sherum", "SherumSkin1", "SherumSkin2"], "芭莉耶": ["Barie"]
};
...
const SD_COSTUME = {
	...
	"羅蕾特": ["Rollett", "RollettSkin2"], "琵拉": ["Pira", "PiraSkin1", "PiraSkin2"], "雪蘭": ["Sherum", "SherumSkin1"], "芭莉耶": ["Barie"]
};
//迷你坨坨SPINE NAME
const MINI_SPINE = {
	...
	"羅蕾特": "Mini_Rollett", "琵拉": "Mini_Pira", "雪蘭": "Mini_Sherum", "芭莉耶": "Mini_Barie"
};
...
const PICKUP_SCHEDULE = [
	...
	{
        start: "2026-09-03T04:00:00+09:00",

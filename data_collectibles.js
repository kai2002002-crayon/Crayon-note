...
const THOUGHT_MAP = {
	"zh-TW": {
			...
			"Daya": "達雅不斷用来檢視並提升外貌的高級鏡子。據說，這是薇薇送給她的禮物",
			...
			"Pira": "不是黃金，而是由黃鐵礦製成的硬幣。這似乎是琵拉開始認同自我價值的象徵。",
        	...
        	"Rollett": "羅蕾特把她自己的手杖送給我了。我試著模仿她的姿勢，結果摔倒了，感覺她好像在某處偷偷看著我。",    
        	...
        	"Tig": "她送我一條頭帶，說如果我戴著它，她就承認我是隊長。這讓我有點為雞啊……",    
...
const LETTER_MAP = {
	"zh-TW": {
            ...
            "Daya": "教主，無論是在宴會廳還是在教團，你總是一如往常地照顧我、為我著想，我很感謝你。你曾經偶然提起過，說也許有一天你會回到故鄉吧?如果那一天真的來了，我該怎麼辦才好呢?沒有教主的艾利亞斯，我實在不願去想。若你要回故鄉，請務必別忘了帶上我。即使是別的世界，只要能和教主在一起，我想我也能幸福……",
            ...
            "Pira": "老大,老大。是我琵拉啦。\n這可不是叫你來借錢的信，放心吧。只是……想謝謝你一直以來各方面的照顧,才寫了這封信,別想太多。\n之前我還在想,其他傢伙為什麼都那麼愛跟著你跑, 現在好像有點懂了。\n以後要是有不錯的生意點子,我會偷偷聯絡你,別錯過好機會囉?那就下次見啦,老大。",
            ...
            "Rollett": "Bonjour(你好)!\n來到妖精王國也過了不少時日了。謝謝你這段時間幫助我適應妖精王國。要是沒有你的幫忙，我肯定很難適應這裡吧。\n真的很感謝你。作為回報，一起喝個下午茶如何？我準備了應該會合你胃口的茶葉與茶點。希望你能在這茶香散去之前來找我。",
            ...
            "Sherum": "教主您好。近來一切安好嗎?我平時不太有機會寫信，因此措辭可能會顯得有些生硬，還請您見諒。一直以來，教主也像貝麗塔女王大人一樣，對我的工作十分包容，我始終心懷感激。身為書記官，若有任何能協助教主的地方，我一定會盡心盡力。還請您不必有所顧慮，和我相處時放輕鬆就好。那麼，就此擱筆。雲蘭 敬上",
            ...
            "Tig": "喂!都是因為你，害我被老太婆罵了啦!村長說什麼 「收了人家的東西就要好好回報」，然後拿著拐杖猛K我欸!為了不讓這種事再發生，你是不是該好好管管我們家老太婆啊?你是想跟我單挑是不是?晚點在宴會廳頂樓準備挨揍吧你!好啦~我心裡也是挺感謝你的啦。但為什麼我非得看那老太婆的臉色來表達啊? 我也有我自己的方式好嗎!所以你晚點就給我乖乖準備接下我的「感謝拳」吧，聽懂沒?",

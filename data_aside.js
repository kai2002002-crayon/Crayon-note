...
const ASIDE_DATA = {
    ...
    "Blanchet": { 
        ...
        stars: {
            1: { 
                icon: "", 
                name: { zh: "盛開的藍玫瑰", ja: "", en: "" }, 
                desc: { zh: "穿戴者的最大HP、魔法攻擊力、爆擊、爆擊傷害增加。", ja: "", en: "." }, 
                effects: { zh: ["最大HP增加:6%", "魔法攻擊力增加:6%", "爆擊增加:6%", "爆擊傷害增加:6%"], ja: [""], en: [""] } 
            },
            2: { 
                icon: "", 
                name: { zh: "百萬繁花綻放", ja: "", en: "" }, 
                desc: { zh: "強化攻擊傷害量增加，且強化攻擊的目標將追加一名隨機敵人。高級技能變更。同步玫瑰會留下標記，於最後一擊時爆炸造成魔法傷害。根據疊加的標記數量將追加爆炸傷害。", ja: "", en: "" }, 
                effects: { zh: ["強化攻擊傷害量增加:240%", "標記爆炸傷害:700%", "標記最大疊加密數:10個", "每要加1層標記追加傷害:16%"], ja: [""], en: [""] } 
            },
            3: { 
                icon: "", 
                name: { zh: "藍色花香的力量", ja: "", en: "" }, 
                desc: { zh: "使所有友軍爆擊及爆擊傷害增加。", ja: "", en: "" }, 
                effects: { zh: ["爆擊增加:6%", "爆擊傷害增加:6%"], ja: [""], en: ["%"] }, 
                globalEffects: { zh: ["全體魔法攻擊力 3%", "全體爆擊傷害抵抗 3%"], ja: ["全体 %", "全体 %"], en: ["All %", "All %"] } 
            }
        }
    },
    "Canna": { 

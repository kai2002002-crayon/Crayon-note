...
const ASIDE_DATA = {
    ...
    "Fricle": { 
        ...
        stars: {
            1: { 
                icon: "", 
                name: { zh: "我的愛徒皮可菈", ja: "我が愛弟子ピコラ", en: "" }, 
                desc: { zh: "穿戴者的最大HP、魔法攻擊力、爆擊、爆擊傷害增加。", ja: "着用者の最大HP、魔法攻撃力、会心、会心ダメージが増加する。", en: "." }, 
                effects: { zh: ["最大HP增加:6%", "魔法攻擊力增加:6%", "爆擊增加:6%", "爆擊傷害增加:6%"], ja: ["最大HP增加:6%", "魔法攻擊力增加:6%", "会心增加:6%", "会心ダメージ増加:6%"], en: [""] } 
            },
            2: { 
                icon: "", 
                name: { zh: "魔女的力量非同凡響!", ja: "魔女の力はすごかった!", en: "" }, 
                desc: { zh: "強化攻擊召喚出的觸手傷害變為2倍，且施放機率增加。高級技能將追加減少防禦力效果。", ja: "強化攻撃で召喚した触手のダメージが2倍になり、発動確率が増加する。高学年スキルに防御力減少効果が追加される。", en: "" }, 
                effects: { zh: ["強化攻擊施展機率增加:7.5%", "防禦力減少:30%", "防禦力減少持續時間:7秒"], ja: ["強化攻撃発動確率增加:7.5%", "防御力減少:30%", "防御力減少の持続時間:7秒"], en: [""] } 
            },
            3: { 
                icon: "", 
                name: { zh: "師父芙莉可的教誨", ja: "師匠フリックルの教え", en: "" }, 
                desc: { zh: "增加中排友軍的每秒SP恢復量。", ja: "中列の味方の1秒ごとのSP回復量を増加させる。", en: "" }, 
                effects: { zh: ["每秒SP恢復量:4"], ja: ["1秒ごとのSP回復量:4"], en: ["%"] }, 
                globalEffects: { zh: ["全體爆擊傷害 3%", "全體爆擊抵抗 3%"], ja: ["全体会心ダメージ 3%", "全体会心抵抗 3%"], en: ["All %", "All %"] } 
            }
        }
    },
    "Haley": { 

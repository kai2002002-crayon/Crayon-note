...
const ASIDE_DATA = {
    ...
    "Kidian": { 
        ...
        stars: {
            1: { 
                icon: "", 
                name: { zh: "夜空的星座", ja: "", en: "" }, 
                desc: { zh: "穿戴者的最大HP、物理攻擊力、爆擊、爆擊傷害增加。", ja: "", en: "." }, 
                effects: { zh: ["最大HP增加:6%", "物理攻擊力增加:6%", "爆擊增加:6%", "爆擊傷害增加:6%"], ja: [""], en: [""] } 
            },
            2: { 
                icon: "", 
                name: { zh: "邊緣人頭槌", ja: "", en: "" }, 
                desc: { zh: "普通技能基本攻擊次數增加。當HP低於50%時，給予自身障眼法效果並恢復SP。", ja: "", en: "" }, 
                effects: { zh: ["障眼法:不會成為敵人的攻擊目標，沒有友軍時不會觸發。", "普通技能基本攻擊次數:4次", "障眼法持續時間:5秒", "SP恢復:60%", "障眼法、SP恢復冷卻時間:8秒"], ja: [""], en: [""] } 
            },
            3: { 
                icon: "", 
                name: { zh: "我會讓你閃閃發光的……", ja: "", en: "" }, 
                desc: { zh: "增加所有友軍對敵人造成的傷害量，並減少所有友軍受到敵人的傷害量。", ja: "", en: "" }, 
                effects: { zh: ["傷害量增加:10.5%" "受到的傷害量減少:4.5%"], ja: [""], en: ["%"] }, 
                globalEffects: { zh: ["全體HP 3%", "全體物理攻擊力 3%"], ja: ["全体 %", "全体 %"], en: ["All %", "All %"] } 
            }
        }
    },
    "Kyarot": { 
    ...
    "Silphir": { 
        ...
        stars: {
            1: { 
                icon: "", 
                name: { zh: "專屬我的藍寶石勳章", ja: "", en: "" }, 
                desc: { zh: "穿載者的最大HP、物理攻擊力、爆擊、爆擊傷害增加。", ja: "", en: "" }, 
                effects: { zh: ["最大HP增加:6%", "物理攻擊力增加:6%", "爆擊增加:6%", "爆擊傷害增加:6%"], ja: [""], en: [""] } 
            },
            2: { 
                icon: "", 
                name: { zh: "萬年老三希菲爾", ja: "", en: "" }, 
                desc: { zh: "回合開始時、攻擊速度提升。使用普通技能後，攻擊速度提升。普通攻撃命中敵人4次時，將於一定時間內增加攻擊力。", ja: "", en: "" }, 
                effects: { zh: ["回合開始時攻撃速度提升:110%", "回合開始時攻擊速度提升持續時間:8秒", "攻擊速度提升:110%", "攻擊速度提升持續時間:8秒", "攻擊力增加:33%", "攻擊力增加持續時間:6秒"], ja: [""], en: [""] } 
            },
            3: { 
                icon: "", 
                name: { zh: "依舊自豪的我", ja: "", en: "" }, 
                desc: { zh: "所有友軍受到敵人的傷害量減少。所有友軍的攻擊速度提升。", ja: "", en: "" }, 
                effects: { zh: ["受到的傷害量減少:4.5%", "攻擊速度提升:3.5%"], ja: [""], en: ["%"] }, 
                globalEffects: { zh: ["全體物理攻擊力 3%", "全體物理防禦力 3%"], ja: ["全体 %", "全体 %"], en: ["All %", "All %"] } 
            }
        }
    },
    "Sist": { 

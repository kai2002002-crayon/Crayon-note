    ...
    "Aya": { 
        ...
        stars: {
            ...
            2: { 
                icon: ""，
                name: { zh: "雪花紛飛", ja: "", en: "" }, 
                desc: { zh: "每4秒充能一次雪花盛開效果。充能完成時，下一次普通攻擊將追加範圍魔法傷害，並給予昏迷效果。普通技能的蝴蝶撞擊敵人時將給予凍傷效果。蝴蝶飛回時、恢復自身HP。", ja: "", en: "" }, 
                effects: { zh: ["凍傷:每秒造成傷害，且受到冷靜性格使者的傷客量增加。", "昏迷:無法進行任何行動。", "雪花盛開魔法傷害:650%", "昏迷持續時間:1.5秒", "凍傷時受到冷靜性格使者傷害量增加:8%", "凍傷持續時間:10秒", "HP恢復:最大HP的20%"], ja: [""], en: [""] } 
            },
            3: { 
                icon: "", 
                name: { zh: "萬年雪的賢者!", ja: "", en: "" }, 
                desc: { zh: "增加中排友軍對敵人造成的傷害量，並減少中排友軍受到的傷害量。", ja: "", en: "" }, 
                effects: { zh: ["傷害量增加:19.5%", "受到的傷害量減少:8.8%"], ja: [""], en: ["%"] }, 
                globalEffects: { zh: ["全體HP 4%", "全體爆擊傷害 4%"], ja: ["全体 %", "全体 %"], en: ["All %", "All %"] } 
            }
        }
    },
    "Barong": { 
